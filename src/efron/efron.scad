...
module efron(colour, set = 1, size = [25, 25]) {
  if (set == 1) {
    if (colour == "blue") {
...
translate([0, 0, 0]) efron("blue", 1);
translate([100, 0, 0]) efron("magenta", 1);
translate([200, 0, 0]) efron("olive", 1);
translate([300, 0, 0]) efron("red", 1);
